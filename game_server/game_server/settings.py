...
SECRET_KEY = 'django-insecure-x&1qazr6%p)o0bhgvh@5^t7@ikj8bmxc6%5=%r9ikkd7z@wboy'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, "tic_tac_toe/static/build")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "tic_tac_toe/static/build/static")
]
